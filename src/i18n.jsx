...
export const STRINGS = {
  en: {
    ...
    'tierlist.manualHint': 'add or remove names, then drag them from S (best) to F. resets to blank next time you open this page.',
  ...
  kk: {
    ...
    'tierlist.manualHint': 'есімдерді қосыңыз не жойыңыз, содан кейін оларды S (ең жақсы) — F-ке дейін сүйреңіз. бұл бетті келесі ашқанда тізім бос болады.',
